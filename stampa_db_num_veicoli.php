<?php
/* API per la stampa di tutto il database con tutti i comuni del Friuli-Venezia-Giulia con anno e numero di veicoli */
...
$query = "SELECT * FROM NUMEROVEICOLI";    //query che andremo ad eseguire
